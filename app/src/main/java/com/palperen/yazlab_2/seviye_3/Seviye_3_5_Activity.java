...
public class Seviye_3_5_Activity extends AppCompatActivity {
    ...
    private long time;
    private int puan;
    Veritabani veritabani =new Veritabani(Seviye_3_5_Activity.this);
    String name;
    int gelenPuan;
    int totalPuan;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seviye_3_5);
        ...
        geri.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent geri_3_5togiris=new Intent(Seviye_3_5_Activity.this, Giris_Ekrani_Activity.class);
                startActivity(geri_3_5togiris);
            }
        });
        ...
        gonder_1_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (dogru_cevap==5){
                    ...
                    Intent seviye_3_5To3_6 = new Intent(Seviye_3_5_Activity.this, Seviye_3_6_Activity.class);
                    seviye_3_5To3_6.putExtra("oyuncuName",name);
                    seviye_3_5To3_6.putExtra("puan",totalPuan);
                    startActivity(seviye_3_5To3_6);
                }
                button_c=false;
                button2_c=false;
                button3_c=false;
