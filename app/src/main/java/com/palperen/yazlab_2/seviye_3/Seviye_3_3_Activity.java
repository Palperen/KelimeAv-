...
public class Seviye_3_3_Activity extends AppCompatActivity {
    ...
    private long time;
    private int puan;
    Veritabani veritabani =new Veritabani(Seviye_3_3_Activity.this);
    String name;
    int gelenPuan;
    int totalPuan;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seviye_3_3);
        ...
        geri.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent geri_3_3togiris=new Intent(Seviye_3_3_Activity.this, Giris_Ekrani_Activity.class);
                startActivity(geri_3_3togiris);
            }
        });
        ...
        gonder_1_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (dogru_cevap==3){
                    ...
                    Intent seviye_3_3To3_4 = new Intent(Seviye_3_3_Activity.this, Seviye_3_4_Activity.class);
                    seviye_3_3To3_4.putExtra("oyuncuName",name);
                    seviye_3_3To3_4.putExtra("puan",totalPuan);
                    startActivity(seviye_3_3To3_4);
                }
                button_c=false;
                button2_c=false;
                button3_c=false;
