...
public class Seviye_3_1_Activity extends AppCompatActivity {
    ...
    private long time;
    private int puan;
    Veritabani veritabani =new Veritabani(Seviye_3_1_Activity.this);
    String name;
    int gelenPuan;
    int totalPuan;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seviye_3_1);
        ...
        geri.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent geri_3_1togiris=new Intent(Seviye_3_1_Activity.this, Giris_Ekrani_Activity.class);
                startActivity(geri_3_1togiris);
            }
        });
        ...
        gonder_1_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (cevap_1_1.equalsIgnoreCase(kelime1)){
                    ...
                    Intent seviye_3_1To3_2 = new Intent(Seviye_3_1_Activity.this, Seviye_3_2_Activity.class);
                    seviye_3_1To3_2.putExtra("oyuncuName",name);
                    seviye_3_1To3_2.putExtra("puan",totalPuan);
                    startActivity(seviye_3_1To3_2);
                }else{
                    yanlis_cevap++;
                }
                button_c=false;
