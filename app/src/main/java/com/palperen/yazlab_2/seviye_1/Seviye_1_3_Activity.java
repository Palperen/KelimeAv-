...
public class Seviye_1_3_Activity extends AppCompatActivity {
    private Chronometer kronometre;
    private Button button_1_2,button2_1_2,button3_1_2,button4_1_2,gonder_1_2,karistir_1_2,geri;
    private TextView text_1_2,text_sal_S,textA_1_2,text_sal_L,text_bal_L,text_bal_B,text_bas_A,text_bas_S;
    ...
    private int puan;
    private long time;
    Veritabani veritabani =new Veritabani(Seviye_1_3_Activity.this);
    String name;
    int gelenPuan;
    int totalPuan;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seviye_1_3);
        ...
        geri.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent geri_2_1togiris=new Intent(Seviye_1_3_Activity.this, Giris_Ekrani_Activity.class);
        ...
        gonder_1_2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (dogru_cevap==3){
                    ...
                    Intent seviye_1_3To1_4 = new Intent(Seviye_1_3_Activity.this,Seviye_1_4_Activity.class);
                    seviye_1_3To1_4.putExtra("oyuncuName",name);
                    seviye_1_3To1_4.putExtra("puan",totalPuan);
                    startActivity(seviye_1_3To1_4);
                }
                button_1_2_c=false;
                button2_1_2_c=false;
                button3_1_2_c=false;
