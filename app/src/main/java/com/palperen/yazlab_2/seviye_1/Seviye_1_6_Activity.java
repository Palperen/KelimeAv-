...
import com.palperen.yazlab_2.seviye_2.Seviye_2_1_Activity;
...
public class Seviye_1_6_Activity extends AppCompatActivity {
    ...
    private TextView text_1_2,text_sal_S,textA_1_2,text_sal_L,text_bal_L,text_bal_B,text_bas_A,text_bas_S,text_sel_E,text_sel_L,text_ela_A,text_bel_B,text_bel_E;
    ...
    private String kelime5="ELA";
    private String kelime6="BEL";
    private List<String> harfler_1_2 = Arrays.asList("S", "A", "L", "B", "E");
    private int puan;
    private long time;
    Veritabani veritabani =new Veritabani(Seviye_1_6_Activity.this);
    String name;
    int gelenPuan;
    int totalPuan;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seviye_1_6);
        ...
        text_ela_A=findViewById(R.id.text_ela_A);
        text_bel_B=findViewById(R.id.text_bel_B);
        text_bel_E=findViewById(R.id.text_bel_E);
        yanlis_cevap=0;
        dogru_cevap=1;
        ...
        geri.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent geri_2_1togiris=new Intent(Seviye_1_6_Activity.this, Giris_Ekrani_Activity.class);
        ...
        gonder_1_2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if ((cevap_1_2.equalsIgnoreCase(kelime1))&&(iskelime1==false)){
                    ...
                    iskelime4=true;
                    dogru_cevap++;
                }else if ((cevap_1_2.equalsIgnoreCase(kelime5))&&(iskelime5==false)){
                    text_sel_E.setText("E");
                    text_bal_L.setText("L");
                    text_ela_A.setText("A");
                    iskelime5=true;
                    dogru_cevap++;
                }else if ((cevap_1_2.equalsIgnoreCase(kelime6))&&(iskelime6==false)){
                    text_bel_B.setText("B");
                    text_bel_E.setText("E");
                    text_sel_L.setText("L");
                    iskelime6=true;
                    dogru_cevap++;
                }
                ...
                if(dogru_cevap==7){
                    ...
                    Intent seviye_1_6To2_1 = new Intent(Seviye_1_6_Activity.this,Seviye_2_1_Activity.class);
                    seviye_1_6To2_1.putExtra("oyuncuName",name);
                    seviye_1_6To2_1.putExtra("puan",totalPuan);
                    startActivity(seviye_1_6To2_1);
                }
                button_1_2_c=false;
                button2_1_2_c=false;
                button3_1_2_c=false;
