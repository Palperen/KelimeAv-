...
public class Seviye_1_5_Activity extends AppCompatActivity {
    ...
    private TextView text_1_2,text_sal_S,textA_1_2,text_sal_L,text_bal_L,text_bal_B,text_bas_A,text_bas_S,text_sel_E,text_sel_L,text_ela_A;
    ...
    private int puan;
    private long time;
    Veritabani veritabani =new Veritabani(Seviye_1_5_Activity.this);
    String name;
    int gelenPuan;
    int totalPuan;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seviye_1_5);
        ...
        geri.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent geri_2_1togiris=new Intent(Seviye_1_5_Activity.this, Giris_Ekrani_Activity.class);
        ...
        gonder_1_2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (dogru_cevap==5){
                    ...
                    Intent seviye_1_5To1_6 = new Intent(Seviye_1_5_Activity.this,Seviye_1_6_Activity.class);
                    seviye_1_5To1_6.putExtra("oyuncuName",name);
                    seviye_1_5To1_6.putExtra("puan",totalPuan);
                    startActivity(seviye_1_5To1_6);
                }
                button_1_2_c=false;
                button2_1_2_c=false;
                button3_1_2_c=false;
