...
public class Seviye_2_5_Activity extends AppCompatActivity {
    private Chronometer kronometre;
    private Button button,button2,button3,button4,button5,gonder_1_1,karistir_1_1,geri;
    private TextView text_1_1,text_saki_S,text_saki_A,text_saki_K,text_saki_I,text_kas_A,text_kas_S,text_asi_A,text_asi_I,text_aksi_A,text_aksi_K,text_aksi_S,text_kisa_I,text_kisa_S,text_kisa_A;
    ...
    private long time;
    private int puan;
    Veritabani veritabani =new Veritabani(Seviye_2_5_Activity.this);
    String name;
    int gelenPuan;
    int totalPuan;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seviye_2_5);
        ...
        geri.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent geri_2_5togiris=new Intent(Seviye_2_5_Activity.this, Giris_Ekrani_Activity.class);
                startActivity(geri_2_5togiris);
            }
        });
        ...
        gonder_1_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (dogru_cevap==5){
                    ...
                    Intent seviye_2_5To2_6 = new Intent(Seviye_2_5_Activity.this, Seviye_2_6_Activity.class);
                    seviye_2_5To2_6.putExtra("oyuncuName",name);
                    seviye_2_5To2_6.putExtra("puan",totalPuan);
                    startActivity(seviye_2_5To2_6);
                }
                button_c=false;
                button2_c=false;
                button3_c=false;
