...
public class Seviye_2_3_Activity extends AppCompatActivity {
    private Chronometer kronometre;
    private Button button,button2,button3,button4,gonder_1_1,karistir_1_1,geri;
    private TextView text_1_1,text_saki_S,text_saki_A,text_saki_K,text_saki_I,text_kas_A,text_kas_S,text_asi_A,text_asi_I;
    ...
    private long time;
    private int puan;
    Veritabani veritabani =new Veritabani(Seviye_2_3_Activity.this);
    String name;
    int gelenPuan;
    int totalPuan;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seviye_2_3);
        ...
        geri.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent geri_2_3togiris=new Intent(Seviye_2_3_Activity.this, Giris_Ekrani_Activity.class);
                startActivity(geri_2_3togiris);
            }
        });
        ...
        gonder_1_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (dogru_cevap==3){
                    ...
                    Intent seviye_2_3To2_4 = new Intent(Seviye_2_3_Activity.this, Seviye_2_4_Activity.class);
                    seviye_2_3To2_4.putExtra("oyuncuName",name);
                    seviye_2_3To2_4.putExtra("puan",totalPuan);
                    startActivity(seviye_2_3To2_4);
                }
                button_c=false;
                button2_c=false;
                button3_c=false;
